...
namespace Kernel
{
    ...
    VectorCohortAging::VectorCohortAging(float _age, float progress, int32_t initial_population, const VectorMatingStructure& _vector_genetics) 
    ...
    VectorCohortAging *VectorCohortAging::CreateCohort(float age, float progress, int32_t initial_population, const VectorMatingStructure& _vector_genetics)
    {
