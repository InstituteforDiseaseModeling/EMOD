...
namespace Kernel {
    ...
    //typedef SpatialReport SpatialReportVector;
    class SpatialReportDengue : public SpatialReportVector
    {
        GET_SCHEMA_STATIC_WRAPPER(SpatialReportDengue)

        public:
            static IReport* CreateReport();
            virtual ~SpatialReportDengue() { }
