 ...
 * 10^0 to 10^9
 */
static const double local_pow10[] = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
...
void modp_dtoa(double value, char* str, int prec)
{
    ...
    if (! (value == value)) {
        ...
        int ret = sprintf_s(str, 100, "%g", value);
        fprintf(stderr, "NAN: value=%f str=%s\n", value, str);
        CaptureCallstack();
        return;
    }
    ...
    int whole = (int) value;
    double tmp = (value - whole) * local_pow10[prec];
