...
def GenerateDemoPoolFiles(demographicFilename, totalPopulation, demoIdList, migrationlinks, returnRate, outputFilename):
    ...
    mixingpool["ScalingMatrix"] = OrderedDict()
    mixingpool["ScalingMatrix"]["Route"] = "Contact"
    mixingpool["ScalingMatrix"]["Matrix"] = []
    for Id in xrange(len(scalingmatrix)):
        mixingpool["ScalingMatrix"]["Matrix"].append(scalingmatrix[Id])
...
if __name__=="__main__":
    ...
    demographicFilename = demographictemplate
    ...
    GenerateDemoPoolFiles(demographictemplate, totalPopulation, demoIdList, migrationlinks, returnRate, outputFilename)
