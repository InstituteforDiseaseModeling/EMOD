...
namespace Kernel
{
    ...
    BaseTextReportEvents::BaseTextReportEvents( const BaseTextReportEvents& rThat )
        : BaseTextReportEventsTemplate( rThat )
    {
    }
    ...
    bool BaseTextReportEvents::IsValidNode( INodeEventContext* pNEC ) const
    {
        return true;
    }
}
