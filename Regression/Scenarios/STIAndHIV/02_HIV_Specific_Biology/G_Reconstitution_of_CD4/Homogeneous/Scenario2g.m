% SUMMARY: Plot CD4 trajectories and population (total, infected, and on ART) over time
% INPUT: 
%   1. output\ReportHIVByAgeAndGender.csv
%   2. output\ReportHIVInfection.csv
...
scenario_name = 'HIV_progression_cohort_2g';
