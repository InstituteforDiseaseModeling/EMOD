...
@del *.txt
@%EMOD_ROOT%build\x64\Release\Eradication\Eradication.exe -C config.json -I . -P %EMOD_ROOT%Regression\shared_embedded_py_scripts -D %EMOD_ROOT%build\x64\Release\> test.txt
