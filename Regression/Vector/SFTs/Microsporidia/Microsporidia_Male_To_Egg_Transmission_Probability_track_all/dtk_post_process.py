...
"""
This test checks individual vectors and should be in sync with the cohort(compartment) test
    ...
    with open(report_name, "w") as outfile:
        ...
        for time in range(simulation_duration):
            ...
            if total_eggs == 0:
                ...
                little_success = dtk_sft.test_binomial_99ci(microsporidia_eggs_today, total_eggs,
