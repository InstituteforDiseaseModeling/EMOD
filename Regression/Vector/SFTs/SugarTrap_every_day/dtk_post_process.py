...
This is a "Vector_Sugar_Feeding_Frequency": "VECTOR_SUGAR_FEEDING_EVERY_DAY" test.
Both males and females should be reduced the same amount since they are both feeding every day. 
We are expected 0.3 vectors to be left after one day since Initial_Effect is 0.7
...
def create_biting_report_file(param_obj,report_name, output_folder, report_vector_stats, debug=False):
    ...
    with open(report_name, "w") as outfile:
        ...
        for sex in sexes:
            ...
            after_intervention = vectors_df.iloc[1][sex]
