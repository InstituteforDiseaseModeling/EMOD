...
Indoor_Biting: 0.7
One person has a PersonalSpatialRepellent with Initial_Effect on 0.4, they get bitten only 0.6 compared to other two
0.6/2.6 = 0.23
other two people = 0.385
...
def application(output_folder="output",
    ...
    humans, human_bites, bites_by_day = veds.track_bites(stdout, start_time=3, debug=False)
    veds.create_biting_report_file(param_obj=param_obj, humans=humans, bites_by_day=bites_by_day,
                                   ...
                                   without_intervention_proportion=0.385,
