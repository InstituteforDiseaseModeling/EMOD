...
Indoor_Biting: 0.7
Giving one person 100% Repelling ScreeningHousingModification
which means one person gets bitter 100% of the time still
and person with bednet gets bitten 30% of the time
this means that 0.3/(2+0.3) = 0.13 of bites are for the person with ScreeningHousingModification
and 1/1.3 =  0.435 of bites are for each of the persons without ScreeningHousingModification
