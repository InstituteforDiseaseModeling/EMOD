...
"""
Verifying that when one person is partially blocked, the other 2 persons are still getting bitten by 1/3 
of the available vectors each
Indoor_Biting: 0.7
Giving one person 100% Blocking SimpleHousingModification
this means that 0.3/(2+0.3) = 0.13 of bites are for the person with SimpleHousingModification
and 1/1.3 =  0.435 of bites are for each of the persons without SimpleHousingModification
...
def application(output_folder="output",
    ...
    veds.create_biting_report_file(param_obj=param_obj, humans=humans, bites_by_day=bites_by_day,
                                   ...
                                   without_intervention_proportion=0.44,
