...
Indoor_Biting: 0.7
Giving one person 100% Repelling MultiInsecticideIRSHousingModification
which means one person gets bitter 100% of the time still
and person with MultiInsecticideIRSHousingModification gets bitten 70% less (or 0.3 of initia) since they are not being bitten indoors
this means that 0.3/(2+0.3) = 0.13 of bites are for the person with MultiInsecticideIRSHousingModification
and 1/1.3 =  0.435 of bites are for each of the persons without MultiInsecticideIRSHousingModification
