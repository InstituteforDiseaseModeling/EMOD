...
if __name__ == "__main__":
    ...
    path_serialized_file = os.path.join(path, "output","state-00051.dtk")

    # opens and saves all nodes, suid
    ser_pop = dft.read(path_serialized_file)
    node = ser_pop.nodes[0]

    print("Check in generated file: m_larval_habitats must not exist, serializationFlags = 27")
    ...
    if m_max_larval_capacity == 12345*2:
        print("Ok! \"arabiensis\"  m_max_larval_capacity == 12345*2")
    else:
        print("Test Failed! \"arabiensis\"  m_max_larval_capacity == 12345*2")

    m_max_larval_capacity = node["m_larval_habitats"][1]["value"][0]["m_max_larval_capacity"]
    if m_max_larval_capacity == 111111 * 2:
        print("Ok! \"funestus\"  m_max_larval_capacity == 111111*2")
    else:
        print("Test Failed! \"funestus\"  m_max_larval_capacity == 111111*2")

    m_max_larval_capacity = node["m_larval_habitats"][2]["value"][0]["m_max_larval_capacity"]
    if m_max_larval_capacity == 222222 * 2:
        print("Ok! \"gambiae\"  m_max_larval_capacity == 222222*2")
    else:
        print("Test Failed! \"gambiae\"  m_max_larval_capacity == 222222*2")