...
if __name__ == "__main__":
    ...
    path_serialized_file = os.path.join(path, "output","state-00021.dtk")
    ...
    if m_max_larval_capacity == 234*2:
        print("Ok! 'arabiensis'  m_max_larval_capacity == 234*2")
    else:
        print("Test Failed! 'arabiensis'  m_max_larval_capacity == 234*2, Actual: ", m_max_larval_capacity)

    m_max_larval_capacity = node["m_larval_habitats"][1]["value"][0]["m_max_larval_capacity"]
    if m_max_larval_capacity == 600000000 * 2:
        print("Ok! 'funestus'  m_max_larval_capacity == 600000000*2")
    else:
        print("Test Failed! 'funestus'  m_max_larval_capacity == 600000000*2")

    m_max_larval_capacity = node["m_larval_habitats"][2]["value"][0]["m_max_larval_capacity"]
    if m_max_larval_capacity == 1250000000 * 2:
        print("Ok! 'gambiae'  m_max_larval_capacity == 1250000000*2")
    else:
        print("Test Failed! 'gambiae'  m_max_larval_capacity == 1250000000*2")