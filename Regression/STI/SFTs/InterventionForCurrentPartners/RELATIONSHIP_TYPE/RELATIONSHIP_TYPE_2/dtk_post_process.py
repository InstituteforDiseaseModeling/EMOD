...
priorities = relationship_types = [sti_s.DemoPfaKeys.commercial,
                                   sti_s.DemoPfaKeys.informal,
                                   sti_s.DemoPfaKeys.marital,
                                   sti_s.DemoPfaKeys.transitory]
                                   
With Maximum_Partners set to 1 and "Relationship_Types" set to ["COMMERCIAL", "INFORMAL","MARITAL","TRANSITORY"], 
make sure the prioritize is commercial > informal > marital > transitory. When there are multiple partners in the 
