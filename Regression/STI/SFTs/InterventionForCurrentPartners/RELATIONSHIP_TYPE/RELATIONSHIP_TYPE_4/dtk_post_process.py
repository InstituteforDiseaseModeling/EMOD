...
priorities = relationship_types = [sti_s.DemoPfaKeys.informal,
                                   sti_s.DemoPfaKeys.marital]

With Maximum_Partners set to 1 and "Relationship_Types" set to ["INFORMAL", "MARITAL"], 
make sure the prioritize is informal > marital. There will not be any event send to male individual in transitory and 
commercial relationships. When there are multiple partners in the same type, make sure it's selecting at random 
between multiple partners of the same type.
